...
### Step 2 — Table of Contents (optional)

**First, assess whether a table of contents is relevant** for this article:
...
Generate the 4 complete MDX files using the following frontmatter format:
...
{validated content for this locale}
```
...
| 2 | Assess if TOC needed | — |
| 2a | Propose TOC (1 lang) | ✅ Validate structure |
| 2b | Translate TOC (3 langs) | ✅ Validate translations |
